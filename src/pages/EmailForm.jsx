    ...
    <>
			{success && (
              ...
              <p className="lg:text-2xl text-black text-center">Mohon tunggu balasan dari kami yaa!</p>
						...
						<div 
							className="hover:cursor-pointer px-6 py-4 border border-black rounded-2xl lg:w-fit mx-auto mt-[18px]  w-[343px]"
			...
			<div className="h-screen overflow-y-scroll relative">
				<form
					ref={form}
					onSubmit={sendEmail}
					className="lg:mx-[110px] lg:my-[68px] my-6 mx-4 h-fit relative"
				>
						<img
							src="/cabinetsLogo/devoria.png"
							alt="Devoria"
							className="absolute top-1/3 left-1/4 lg:left-auto lg:right-0 w-[362px] opacity-[12%] -z-10"
						/>
						<div className="flex flex-col lg:gap-10 gap-[85px]">
							<div
								className="flex gap-4 items-center cursor-pointer hover:bg-gray-100 px-4 py-2 rounded-2xl w-fit"
						...
						<div className="mt-16 flex flex-col lg:gap-10 gap-4">
							<div className="flex flex-col gap-4">
								...
								<input
									type="email"
									name="from_email"
									className="border-1 border-[#979797] rounded-2xl px-6 py-4 lg:w-[800px]"
							...
							<div className="lg:flex flex-row items-end lg:justify-between w-full">
								<div className="flex flex-col gap-4">
									...
									<textarea
										name="message"
										rows="4"
										className="border-1 border-[#979797] rounded-2xl px-6 py-4 lg:w-[800px] w-full lg:max-h-[250px]"
										placeholder="Ketik aspirasimu disini"
										required
									/>
								</div>
