...
export const Contacts = () => {
  return (
    <div
      id="contact"
      className={`bg-[url(/ornaments/rectangle498.png)] w-full lg:pt-[220px] pt-10 px-4 bg-cover bg-center flex lg:flex-row flex-col-reverse lg:items-start items-center lg:gap-4 gap-6 justify-center lg:pb-0 pb-[64px] ${
        location.pathname === "/contact" ? "-mt-[135px] pt-40 min-h-screen" : "mt-0"
      }`}
    >
